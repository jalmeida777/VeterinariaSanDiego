<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarPacienteEstado.aspx.cs" Inherits="ListarPacienteEstado" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <div class="divBusqueda">
                <table width="100%" cellpadding="3" cellspacing="3">
                    <tr>
                        <td colspan="2">
                            <h1 class="label">
                                Administración de Estado de Pacientes</h1>
                        </td>
                    </tr>
                    <tr>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                Width="100%">
                <asp:GridView ID="gvPacienteEstado" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="i_IdPacienteEstado" 
                    onrowdatabound="gvAlmacen_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="i_IdPacienteEstado" HeaderText="Id" Visible="False">
                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="v_Estado" HeaderText="Descripcion"></asp:BoundField>
