<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarSexo.aspx.cs" Inherits="ListarSexo" %>
            ...
            <div class="divBusqueda">
                <table width="100%" cellpadding="3" cellspacing="3">
                    <tr>
                        <td colspan="2">
                            <h1 class="label">
                                Administración de Sexo de Paciente</h1>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="toolbar">
                <table width="100%">
                    ...
                    ImageUrl="~/images/Buscar.jpg" onclick="btnConsultar_Click" />
                        ...
                        onclick="btnNuevo_Click" style="height: 22px" />
                        </td>
                        <td>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gvAlmacen" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="i_IdSexo" 
                    onrowdatabound="gvAlmacen_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="i_IdSexo" HeaderText="Id" Visible="False">
