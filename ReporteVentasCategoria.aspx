<%@ Page Title="Reporte de Ventas por Categoria" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ReporteVentasCategoria.aspx.cs" Inherits="ReporteVentasCategoria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="divBusqueda">
        <table width="100%">
            ...
            &nbsp;Reporte de Ventas por Categoría</h1>
                </td>
            </tr>
            <tr>
                <td>
 ...
 <div class="toolbar">
    ...
    ConnectionString="<%$ ConnectionStrings:PlayConnectionString %>" SelectCommand="Play_VentasxCategoria_Reporte" 
    SelectCommandType="StoredProcedure">
        <SelectParameters>
            ...
            <asp:ControlParameter ControlID="lblFechaFinal" Name="fechaFinal" 
                PropertyName="Text" Type="String" />
            <asp:ControlParameter ControlID="lblAlmacen" Name="almacen" PropertyName="Text" 
                Type="String" />
        </SelectParameters>
        </asp:SqlDataSource>
                         <table width="100%" 
    ...
    WaitMessageFont-Size="14pt" Width="100%">
                    <LocalReport ReportPath="VentasPorCategoria.rdlc">
                        <DataSources>
