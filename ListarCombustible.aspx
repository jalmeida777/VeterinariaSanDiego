<%@ Page Title="Listar Combustible" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarCombustible.aspx.cs" Inherits="ListarCombustible" %>
            ...
            <div class="divBusqueda">
                <table width="100%" cellpadding="3" cellspacing="3">
                    <tr>
                        <td colspan="2">
                            <h1 class="label">
                                Administración de Combustibles</h1>
                        </td>
                    </tr>
                    <tr>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gvCategoria" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="i_IdCombustible" 
                    onrowdatabound="gvCategoria_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="i_IdCombustible" HeaderText="Id" Visible="False">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="v_NombreCombustible" HeaderText="Combustible">
                        </asp:BoundField>
