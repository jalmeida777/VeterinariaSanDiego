<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="CrearMedico.aspx.cs" Inherits="CrearMedico" %>
                ...
                &nbsp;</td>
                    ...
                    <tr>
                        <td height="10" width="20">
                            &nbsp;</td>
                        <td>
                            <asp:Label ID="Label5" runat="server" Text="Colegiatura:"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtColegiatura" runat="server" CssClass="inputNormal" placeholder="Descripción"
                    Width="136px" style="text-transform:uppercase"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtEmail" runat="server" CssClass="inputNormal" placeholder="Descripción"
                    Width="300px" style="text-transform:uppercase"></asp:TextBox>
                        </td>
                        <td>
                            &nbsp;</td>
