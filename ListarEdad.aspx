<%@ Page Title="Administración de Edades" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarEdad.aspx.cs" Inherits="ListarEdad" %>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gvEdad" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="n_IdEdad" onrowdatabound="gvEdad_RowDataBound" 
                    Width="100%">
                    <Columns>
                        <asp:BoundField DataField="n_IdEdad" HeaderText="Id" Visible="False">
