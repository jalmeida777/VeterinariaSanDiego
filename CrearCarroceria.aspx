<%@ Page Title="Crear Carroceria" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="CrearCarroceria.aspx.cs" Inherits="CrearCarroceria" %>
 ...
 <div class="toolbar">
        ...
        <tr>
            <td height="10" width="20">
                &nbsp;</td>
            <td>
                                <asp:Label ID="Label18" runat="server" Text="Categoria"></asp:Label>
                            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDescripcion" runat="server" CssClass="inputNormal" placeholder="Descripción"
                    Width="300px" style="text-transform:uppercase" MaxLength="150"></asp:TextBox>
