<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarTipoCliente.aspx.cs" Inherits="ListarTipoCliente" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <div class="divBusqueda">
                <table width="100%" cellpadding="3" cellspacing="3">
                    <tr>
                        <td colspan="2">
                            <h1 class="label">
                                Administración de Tipo de Clientes</h1>
                        </td>
                    </tr>
                    <tr>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                Width="100%">
                <asp:GridView ID="gvTipoCliente" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="i_IdTipoCliente" 
                    onrowdatabound="gvAlmacen_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="i_IdTipoCliente" HeaderText="Id" Visible="False">
