<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarCiaCelular.aspx.cs" Inherits="ListarCiaCelular" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <div class="divBusqueda">
                <table width="100%" cellpadding="3" cellspacing="3">
                    <tr>
                        <td colspan="2">
                            <h1 class="label">
                                Administración de Compañia de Celulares</h1>
                        </td>
                    </tr>
                    <tr>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                Width="100%">
                <asp:GridView ID="gvCiaCelular" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="i_IdCiaCelular" 
                    onrowdatabound="gvAlmacen_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="i_IdCiaCelular" HeaderText="Id" Visible="False">
