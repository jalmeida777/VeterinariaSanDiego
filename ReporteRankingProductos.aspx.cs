...
public partial class ReporteRankingProductos : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "RankingProductos.rdlc";
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportDataSource rds = new ReportDataSource();
            rds.Name = "dsRank";
            SqlDataAdapter da = new SqlDataAdapter("Play_Rancking_Productos_Reportes '" + lblFechaInicial.Text + "','" + lblFechaFinal.Text + "','" + lblAlmacen.Text + "'", conexion);
