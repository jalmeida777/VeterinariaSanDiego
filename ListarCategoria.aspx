        ...
        <div class="divBusqueda">
            <table width="100%" cellpadding="3" cellspacing="3">
                <tr>
                    <td colspan="2">
                        <h1 class="label">
                            Administración de Categorías</h1>
                    </td>
                </tr>
                <tr>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gvCategoria" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="i_IdCategoria" 
                    onrowdatabound="gvCategoria_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="i_IdCategoria" HeaderText="Id" Visible="False">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="v_Categoria" HeaderText="Categoría">
                        </asp:BoundField>
