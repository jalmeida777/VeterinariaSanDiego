<%@ Page Title="Clase de Vehículo" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarClaseVehiculo.aspx.cs" Inherits="ListarClaseVehiculo" %>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="i_IdClaseVehiculo" 
                    onrowdatabound="gv_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="i_IdClaseVehiculo" HeaderText="Id" Visible="False">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="v_NombreClase" HeaderText="Clase de Vehículo">
                        </asp:BoundField>
