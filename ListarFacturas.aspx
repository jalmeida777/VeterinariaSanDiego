<%@ Page Title="Facturas" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarFacturas.aspx.cs" Inherits="ListarFacturas" %>
        ...
        <div class="divBusqueda">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td width="80">
                        <asp:Label ID="Label4" runat="server" Font-Bold="False" Text="Factura N°:"></asp:Label>
                    </td>
                    <td width="90">
                        <asp:TextBox ID="txtFactura" runat="server" AutoPostBack="True" 
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gvPedido" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="f_SubTotal" DataFormatString="{0:n2}" 
                            HeaderText="SubTotal">
                        <ItemStyle HorizontalAlign="Right" Width="100px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="f_Impuesto" DataFormatString="{0:n2}" 
                            HeaderText="Impuesto">
                        <ItemStyle HorizontalAlign="Right" Width="100px" />
                        </asp:BoundField>
