<%@ Page Title="Listar Carrocerias" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarCarroceria.aspx.cs" Inherits="ListarCarroceria" %>
            ...
            <div class="divBusqueda">
                <table width="100%" cellpadding="3" cellspacing="3">
                    <tr>
                        <td colspan="2">
                            <h1 class="label">
                                Administración de Carrocerías</h1>
                        </td>
                    </tr>
                    <tr>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="i_IdCarroceria" 
                    onrowdatabound="gvModelo_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="i_IdCarroceria" HeaderText="Id" Visible="False">
                        <HeaderStyle HorizontalAlign="Center" />
                        <ItemStyle HorizontalAlign="Center" Width="50px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="v_NombreCarroceria" HeaderText="Carrocería">
                        </asp:BoundField>
